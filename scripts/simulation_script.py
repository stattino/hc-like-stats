...
filename = '../plots/heatmaps/R-Errorbars_M={}_K={}_p_{}_beta={}_theta={}_alphacs={}_alphahc={}.png'.format(M, K, p, beta, theta, alpha_cscshm, alpha_hc)
