...
for j in range(0, M_2):
    ...
    for i in range(0, M):
        ...
        #print('Error= ', error_hc[i], 'size', y_test.shape, 'total errors:', sum(y_attempt != y_test))
        ...
        #print('Error= ', error_cs1[i], 'size', y_test.shape, 'total errors:', sum(y_attempt != y_test))
        ...
        #print('Error= ', error_cs2[i], 'size', y_test.shape, 'total errors:', sum(y_attempt != y_test))
